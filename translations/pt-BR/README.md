# Agentes de IA para Principiantes - Um Curso

![Agentes de IA para Principiantes](../../translated_images/pt-BR/repo-thumbnailv2.06f4a48036fde647.webp)
...
[![Colaboradores GitHub](https://img.shields.io/github/contributors/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
> ```
>
> Isso oferece tudo o que você precisa para completar o curso com um download muito mais rápido.
...
Este curso possui aulas que cobrem os fundamentos da construção de Agentes de IA. Cada aula aborda seu próprio tópico, então comece de onde quiser!

Há suporte multilíngue para este curso. Veja nossos [idiomas disponíveis aqui](#-multi-language-support). 

Se esta for sua primeira vez construindo com modelos de IA Generativa, confira nosso curso [IA Generativa Para Iniciantes](https://aka.ms/genai-beginners), que inclui 21 aulas sobre construção com GenAI.

Não se esqueça de [estrelas (🌟) este repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [fazer fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Conheça Outros Aprendizes, Tire Suas Dúvidas

Se ficar travado ou tiver dúvidas sobre como construir Agentes de IA, junte-se ao nosso canal dedicado no Discord em [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### O Que Você Precisa 

Cada aula deste curso inclui exemplos de código, que podem ser encontrados na pasta code_samples. Você pode [fazer fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para criar sua própria cópia.  

Os exemplos de código nestes exercícios utilizam o Microsoft Agent Framework com o Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Requer Conta Azure
...
Você tem sugestões ou encontrou erros de ortografia ou de código? [Abra uma issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ou [Crie um pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Cada aula inclui

- Uma aula escrita localizada no README e um vídeo curto
...
| **Aula**                                    | **Texto & Código**                                  | **Vídeo**                                                  | **Aprendizado Extra**                                                                 |
|---------------------------------------------|----------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
...
| Compreendendo Padrões de Design Agenticos     | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Usando Protocolos Agentic (MCP, A2A e NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Vídeo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gerenciando Memória Agentic                      | [Link](./13-agent-memory/README.md)     |      [Vídeo](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Explorando Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Construindo Agentes de Uso de Computador (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
Obrigado a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir com amostras de código importantes demonstrando Agentic RAG.

## Contribuindo

Este projeto aceita contribuições e sugestões. A maioria das contribuições requer que você concorde com um Acordo de Licença de Contribuinte (CLA) declarando que você tem o direito e realmente concede a nós os direitos para usar sua contribuição. Para mais detalhes, visite <https://cla.opensource.microsoft.com>.
...
Este projeto adotou o [Código de Conduta de Código Aberto da Microsoft](https://opensource.microsoft.com/codeofconduct/). Para mais informações veja o [FAQ do Código de Conduta](https://opensource.microsoft.com/codeofconduct/faq/) ou contate [opencode@microsoft.com](mailto:opencode@microsoft.com) com quaisquer perguntas ou comentários adicionais.
...
[Diretrizes de Marcas Registradas e Marca da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
